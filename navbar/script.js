function Navbar(){
          ...
          <div>
            ...
            <div>
              <div id="fashion">
                ...
                <button class="sub1"  >Ties,Cufflinks & Pocket Squares</button>
    ...
    <!-- Women page -->
      <div class="dropdown">
      <button class="dropbtnW" id="Womenpage">WOMEN</button>
      ...
      <div class="dropdown">
        <button class="dropbtnK" id="kidspage" >KIDS</button>
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content" id="Subway3">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content" id="Subway4">
    ...
    <div id="details2">
      <div class="dropdownP">
        ...
        <div class="dropdownP-content">
          <div>
            <div style="line-height: 1px;">
              <h5 style="margin-left: 20px;color: #282c3f">Welcome</h5>
              <p>to access account and manage orders</p>
            </div>
            
            <br>
        
            <button id="loginnav" style="color: red;margin-left: 40px;margin-top: 15px;">LOGIN/SIGNUP</button>
            <br>
            <br>
            <br>
            <div id="details3">
              <button class="sub1" >Orders</button>
                  <br>
                  <button class="sub1" >Wishlist</button>
                  <br>
                  <button class="sub1" >Gift Cards</button>
                  <br>
                  <button class="sub1" >Contact Us</button>
                  <br>
                  <button class="sub1" >Myntra Insider <sup style="color: white;background-color: red;">New</sup></button>
                  <br>
                  <br>
                  <br>
                  <button class="sub1" >Myntra Credit</button>
                  <br>
                  <button class="sub1" >Coupons</button>
                  <br>
                  <button class="sub1" >Saved Cards</button>
            </div>
        ...
        <div id="details">
          ...
          <button id="wishlistpage">Wishlist</button>
        </div>
        <div id="details1">
