...
<head>
    ...
    <link rel="stylesheet" href="./style/mensprod.css" />

      <!-- fontawesome script -->
    <script src="https://kit.fontawesome.com/d9e48e53e2.js" crossorigin="anonymous"></script>

       <!-- scripts -->
    <script type="module" src="./script//wishlist.js"></script>
    <!-- <style>
        #wishList{
            display: flex;
            gap: 10px;
...
<body>
    ...
    <div style="display: flex;">
        <h3 style="padding-left:20px; font-weight:650">My Wishlist</h3>
         <p style="padding:5px 0px 0px 10px" class="wishlistItemsCount">items</p>
        </div>
<div class="mensProductsCont" style="margin-bottom: 250px; margin-left: 70px;">
...
//     alert('Data is only available for mens now, please check mens page');
// };
...
document.querySelector("#beautypage").addEventListener("dblclick",displaydb4);
function displaydb4(){
...
//      let data = document.getElementById("wishData");
//     let wishData = JSON.parse(localStorage.getItem("productwishlisted")) || [];
//     console.log(wishData);
// function wish(){
//     wishData.map(function(product,i){
  
//   let div = document.createElement("div");
//   let img  = document.createElement("img");
//    img.src = product.imglink[0];
//    let n = document.createElement("h3");
//    n.innerHTML =  `Type :-${product.name}`;
//    let price = document.createElement("p");
//    price.innerHTML = `Price :- ${product.price}`;
//    let remove = document.createElement("button");
//    remove.setAttribute("class","button");
//     remove.innerText = product.remove;
//    remove.innerHTML = "Remove";

//   remove.addEventListener("click",function(event){
//     wishData.splice(i,1);
//      localStorage.setItem("productwishlisted",JSON.stringify(wishData));
//      window.location.reload();
//   })

//    div.append(img,n,price,remove);
//    data.append(div);
//  });
// }
// wish();
